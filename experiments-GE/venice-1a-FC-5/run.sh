...
# City name {venice, manhattan, sanfrancisco}
CITY=venice
...
python editSettings.py $CITY $CONFIGURATION_FILE".txt" $INDIVIDUAL_FILE $NR_REP $SIM_LENGTH > $SEEDS_FILE"_"$BASE_NAME
...
mv $SEEDS_FILE"_"$BASE_NAME $TMP_DIR/$SEEDS_FILE
